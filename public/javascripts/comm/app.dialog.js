	...
	var M = {
		...
		tipsErr:function(c, opt){//（失败）提示信息
			...
			M.exec({
				...
				width:674,
				style:'margin:0 auto; height:80px;',
				css: '#{id} .closeRight{display:none} #{id} .dialogBody{  box-shadow:none;background:none;height:218px;width:700px;  text-align: center; background:url('+M.$skin+'dialog_tips_bg.png) no-repeat !important}.dialogText_tips{font-size: 16px;color: #fff;}.dialogContent{margin-top: 40px;}p.dialog_img_tips{ background-position:0 -324px;}'
			}, opt);
		},
